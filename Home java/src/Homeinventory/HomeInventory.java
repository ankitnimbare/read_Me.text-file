...
y += dy;
g2D.drawString("Price: $" + HomeInventory.myInventory[i].purchasePrice + ",Suven InternshipPurchased on: " + HomeInventory.myInventory[i].purchaseDate, (int) (pf.getImageableX() +
25), y);
y += dy;
